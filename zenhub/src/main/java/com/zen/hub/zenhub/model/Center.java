...
public class Center {
	...
	private String centerOwnerLandPhone;
	private String centerOwnerMobilePhone;	
	private Integer centerCustomerRating;	
	private Integer centerLevel;
	private Date centerCloseStartDate;
	private Date centerCloseEndDate;	
	private boolean centerOpenStatus;	
	private Date centerModifiedDate;	
	private String centerModifiedBy;
	...
	public byte[] getCenterLogo() {
		return centerLogo;
	}
	public void setCenterLogo(byte[] centerLogo) {
		this.centerLogo = centerLogo;
	}
		
	public Date getCenterOpendDate() {
		return centerOpendDate;
	}
	public void setCenterOpendDate(Date centerOpendDate) {
		this.centerOpendDate = centerOpendDate;
	}
	...
	public String getCenterOwnerLandPhone() {
		return centerOwnerLandPhone;
	}
	public void setCenterOwnerLandPhone(String centerOwnerLandPhone) {
		this.centerOwnerLandPhone = centerOwnerLandPhone;
	}
	public String getCenterOwnerMobilePhone() {
		return centerOwnerMobilePhone;
	}
	public void setCenterOwnerMobilePhone(String centerOwnerMobilePhone) {
		this.centerOwnerMobilePhone = centerOwnerMobilePhone;
	}
	public Integer getCenterCustomerRating() {
		return centerCustomerRating;
	}
	public void setCenterCustomerRating(Integer centerCustomerRating) {
		this.centerCustomerRating = centerCustomerRating;
	}
	public Integer getCenterLevel() {
		return centerLevel;
	}
	public void setCenterLevel(Integer centerLevel) {
	...
	public Date getCenterCloseEndDate() {
		return centerCloseEndDate;
	}
	public void setCenterCloseEndDate(Date centerCloseEndDate) {
		this.centerCloseEndDate = centerCloseEndDate;
	}
	...
	public Date getCenterModifiedDate() {
		return centerModifiedDate;
	}
	public void setCenterModifiedDate(Date centerModifiedDate) {
		this.centerModifiedDate = centerModifiedDate;
	}
	public String getCenterModifiedBy() {
		return centerModifiedBy;
	}
	public void setCenterModifiedBy(String centerModifiedBy) {
		this.centerModifiedBy = centerModifiedBy;
	}		
